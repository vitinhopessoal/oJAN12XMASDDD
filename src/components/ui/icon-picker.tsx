...
export const FINANCE_ICONS = [
  ...
  "repeat", "shopping-cart", "shirt", "plane", "fuel", "wifi",
  "smartphone", "gift", "baby", "dog", "wrench", "scissors",
  "dumbbell", "film", "music", "book-open", "coffee", "pizza",
  "bus", "briefcase", "laptop", "trending-up", "coins", "banknote",
  "piggy-bank", "wallet", "credit-card", "receipt", "landmark", "hand-coins",
  "circle-dollar-sign", "sparkles", "tag", "circle",
];
